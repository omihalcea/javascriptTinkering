...
import Calculator from '@/views/CalculadoraView.vue'; // Canvia el camí al component de la teva calculadora
...
describe('Calculator.vue', () => {
    ...
    it('should replace 0 with the first number entered', async () => {
        ...
        expect(wrapper.find('.display').text()).toBe('53'); // Verifica que el número s'afegeix correctament
    });
    ...
    it('should calculate the result correctly', async () => {
        ...
        expect(wrapper.find('.display').text()).toBe('8'); // Comprova que el resultat sigui correcte
    });
